...
define("EWR_PROJECT_ID", "{6DE8D047-F903-489E-ADDD-B2DD0934F9B4}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "arsip", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'SrOmRM0QWCU4qhRE', TRUE); // Random key for encryption
