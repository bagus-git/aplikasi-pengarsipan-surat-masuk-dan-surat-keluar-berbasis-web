...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO disposisi (no_disposisi, no_agenda, no_surat, kepada, keterangan, status_surat, tanggapan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1>INPUT DATA DISPOSISI</h1>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">No_disposisi:</td>
          <td><input type="text" name="no_disposisi" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="kepada" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="status_surat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
