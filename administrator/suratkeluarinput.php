...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO surat_keluar (no_agenda, id, jenis_surat, tanggal_kirim, no_surat, pengirim, perihal) VALUES (%s, %s, %s, %s, %s, %s, %s)",
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="no_surat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
